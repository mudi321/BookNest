        ...
        
        {
            news.map((item,index) => (
                <SwiperSlide key={index}>
                    <div className='flex flex-col sm:flex-row sm:jusitify-between items-center gap-12'>
                        <div className='py-4'>
                            <Link to="/">
                                <h3 className='text-lg font-matteBlack font-secondary hover:text-tertiary mb-4'>
                                    {item.title}
                                </h3>
                            </Link>
                            ...
                            <p className='text-sm font-secondary text-gray-600'>{item.description}</p>
                        </div>
