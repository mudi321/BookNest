...
const Dashboard = () => {
    ...
    <aside className="hidden sm:flex sm:flex-col">
      <a href="/" className="inline-flex items-center justify-center h-20 w-20 bg-gray-800 hover:bg-tertiary focus:bg-tertiary">
        <img src="/fav-icon.png" alt="" className='h-12 w-12'/>
      </a>
