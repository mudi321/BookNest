    ...
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>  
                  <span className="block text-2xl font-bold"><Number n={data?.totalBooks}/></span>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="flex text-2xl font-bold">$<Decimal n={data?.totalSales}/></span>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="inline-block text-2xl font-bold"><Number n={data?.trendingBooks}/></span>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold"><Number n={data?.totalOrders}/></span>
            ...
            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold"><Number n={4}/></span>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold"><Number n={139}/></span>
